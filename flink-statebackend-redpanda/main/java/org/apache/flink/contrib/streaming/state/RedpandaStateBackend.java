...
/** */
@PublicEvolving
public class RedpandaStateBackend extends AbstractRedpandaStateBackend
        implements ConfigurableStateBackend {

    /** Creates a new {@code RedpandaStateBackend} for storing local state. */
     ...
     */
    @Override
    public RedpandaStateBackend configure(ReadableConfig config, ClassLoader classLoader) {
        return new RedpandaStateBackend(this, config, classLoader);
    }
