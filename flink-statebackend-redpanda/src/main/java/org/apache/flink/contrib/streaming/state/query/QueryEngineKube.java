...
public class QueryEngineKube {
    ...
    private QueryEngineKube(String table_name, String directory_daemon_address_){
    ...
    private void createProducer() {
        ...
        props.put(ProducerConfig.CLIENT_ID_CONFIG, "OffsetProducer (QueryEngineKube)");
    ...
    public static void main(String[] args) throws SqlException {
        ...
        QueryEngineKube redpanda_engine = new QueryEngineKube(table_name, "192.168.122.132");
